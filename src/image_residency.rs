//! Process-wide accounting for image pixels and GPU textures.
//!
...
mod tests {
    ...
    #[test]
    #[ignore = "optimized image residency probe"]
    fn optimized_image_residency_probe() {
        let page_bytes = 8 * 1024 * 1024;
        let owner = WindowSessionId::new(1);
        for pages in [1_usize, 20, 100] {
            ...
            println!(
                "image_residency,pages={pages},legacy_bytes={legacy_bytes},resident_pages={},decoded_bytes={},texture_bytes={},legacy_ns={old_ns},cold_ns={cold_ns},warm_ns={warm_ns},idle_ns={idle_ns},scroll_ns={scroll_ns},zoom_ns={zoom_ns}",
                budget.entries.len(),
