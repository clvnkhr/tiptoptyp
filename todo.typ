...
160. [ ] (Deferred; audit 159 follow-up) Give the retained hidden root a dormant-host lifecycle: suspend document-only rendering and services without interrupting Settings, native commands, pending dialogs or process-operation completions. Profile the no-window workload before and after, and test reopening without stale work or duplicate service starts.
